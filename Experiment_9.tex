...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{pla_convergence.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{mlp_tuning_barplot.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{mlp_regularization.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{mlp_training_curve.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\linewidth]{final_metrics_barplot.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{hardest_classes.png}
